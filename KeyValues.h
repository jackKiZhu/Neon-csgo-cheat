...
//typedef void* KeyValues; // TODO: Move U::LoadFromBuffer/etc to class
/*class KeyValues
{
...
public:
	KeyValues(const char* setName)
	{
		reinterpret_cast<void(__thiscall*)(PVOID, const char*)>(OFFSET_KEYVALUES_CONSTRUCTOR)(this, setName);
	}

	bool LoadFromFile(DWORD filesystem, const char* resourceName, const char* pathID = NULL, DWORD pfnEvaluateSymbolProc = NULL)
	{
		return reinterpret_cast<bool(__thiscall*)(PVOID, DWORD, const char*, const char*, DWORD)>(OFFSET_KEYVALUES_LOADFROMFILE)(this, filesystem ? filesystem + 4 : NULL, resourceName, pathID, pfnEvaluateSymbolProc);
	}

	KeyValues* FindKey(const char* keyName, bool bCreate = false)
	{
		return reinterpret_cast<KeyValues*(__thiscall*)(PVOID, const char*, bool)>(OFFSET_KEYVALUES_FINDKEY)(this, keyName, bCreate);
	}
	...
	//{
	//	return CallVFunc<PVOID(__thiscall*)(PVOID, size_t)>(KeyValuesSystem(), 1)(KeyValuesSystem(), iAllocSize);
	//}

	//void operator delete(PVOID pMem)
	//{
	//	CallVFunc<void(__thiscall*)(PVOID, PVOID)>(KeyValuesSystem(), 2)(KeyValuesSystem(), pMem);
	//}
	...
	{
		reinterpret_cast<void(__thiscall*)(PVOID, KeyValues*, MergeKeyValuesOp_t)>(OFFSET_KEYVALUES_MERGEFROM)(this, kvMerge, eOp);
	}
