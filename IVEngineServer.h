...
public:
	void GetActiveSounds(CUtlVector<SndInfo_t> & sndlist)
	{
		...
		return CallVFunc< FnGetName >(this, 19)(this, sndlist);
	}
};
...
//{
//	// 55 8B EC 83 E4 F8 83 EC 6C
//	typedef int(__stdcall* OriginalFn)(IRecipientFilter&, int, const google::protobuf::Message&);
//	auto SendUserMessageFn = (OriginalFn)U::FindPattern("engine.dll", "SendUserMessage", "55 8B EC 83 E4 F8 83 EC 6C 8D 4C");
//	SendUserMessageFn(filter, message, msg);
//}

//class IVEngineServer
//{
//	// 45 / 46
//	void GetClientNetworkable(IRecipientFilter &filter, int message, const google::protobuf::Message &msg)
//	{
//		typedef void(__thiscall* OriginalFn)(IRecipientFilter&, int, const google::protobuf::Message&);
//		return CallVFunc<OriginalFn>(this, 45)(filter, message, msg);
//	}
//};
